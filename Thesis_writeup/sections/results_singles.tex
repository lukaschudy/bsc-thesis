...
\begin{table}[H]
\centering
\caption{Single friction sweeps. SD is cross-session standard deviation. The $L=0$, $\sigma=0$, and $T=0$ cells all reproduce the baseline ($\Delta=0.843$) bit-for-bit, which is the internal sanity check.}
\label{tab:singles}
